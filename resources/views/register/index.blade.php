      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          <a class="logo" href="index.html">
            <img src="{{ asset('assets/images/logo.png') }}" width="200px" height="80px" class="text-center" alt="">
          </a>
          ...
          <form class="text-left clearfix" method="post" action="/register">
            ...
            <div class="form-group">
              <input type="email" class="form-control  @error('email') is_invalid @enderror" name="email" placeholder="Email" required autocomplete="email">
              @error('email')
              <div class="invalid-feedback">
                {{$message}}
              </div>
