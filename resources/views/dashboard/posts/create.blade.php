                ...
                <div class="card-body pt-2">
                    <form action="/dashboard/posts" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group input-group-static my-4">
                            ...
                            <input type="text" class="form-control @error('lowongan') is-invalid @enderror" id="lowongan" name="lowongan" autofocus value="{{ old('lowongan') }}">
                        ...
                        <div class="input-group input-group-static my-4">
                            ...
                            <input type="text" class="form-control @error('gaji') is-invalid @enderror" placeholder="Ex : Negoitable or Rp1.500.000 - Rp5.000.000" id="gaji" name="gaji">
                            <div class="text-danger">
                                @error('gaji')
                                {{ $message }}
                                @enderror
                        ...
                        <label for="mulai" class="form-label">Buka Lowongan</label>
                        ...
                        <label for="selesai" class="form-label">Deadline Lowongan</label>
                        <div class="input-group input-group-static">
                            
                            <input type="date" class="form-control @error('selesai') is-invalid @enderror" id="selesai" name="selesai">
                            <div class="text-danger">
                                @error('selesai')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="input-group input-group-static my-4">
                            ...
                            <input type="text" class="form-control @error('pengalaman') is-invalid @enderror" placeholder="Ex : 1 Tahun" id="pengalaman" name="pengalaman">
                            <div class="text-danger">
                                @error('pengalaman')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="input-group input-group-static">
                                <input id="keterangan" class="form-control @error('keterangan') is-invalid @enderror" type="hidden" name="keterangan">
                        ...
                        <div class="input-group input-group-static my-4">
                            ...
                            <input type="file" class="form-control @error('sampul') is-invalid @enderror" id="sampul" name="sampul" placeholder="Gaji Pokok" onchange="previewSampul()">
                            <div class="text-danger">
                                @error('sampul')
                                {{ $message }}
                                @enderror
