        ...
        <div class="col-lg-10 col-12 mx-auto position-relative">
            <div class="card">
                ...
                <div class="card-body pt-2">
                    <form action="/keahlian" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="input-group input-group-static my-4">
                            <label for="keahlian" class="form-label">Keahlian</label>
                            <input type="text" class="form-control @error('name_keahlian') is-invalid @enderror" id="keahlian" name="name_keahlian" autofocus value="{{ old('name_keahlian') }}">
