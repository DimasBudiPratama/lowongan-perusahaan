...
<link rel="icon" type="image/png" href="{{ asset('assets/images/itn.png') }}">
...
<!-- Trix Editor -->
<link rel="stylesheet" type="text/css" href="{{ asset('assets/dashboard/css/trix.css') }}">
...
<!-- Trix Editor -->
<script type="text/javascript" src="{{ asset('assets/dashboard/js/trix.js') }}"></script>


<!-- <script type="text/javascript" src="{{ asset('assets/dashboard/js/jquery-3.5.1.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('assets/dashboard/js/sweetalert.min') }}"></script>
...
<!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc --><script src="{{ asset('assets/dashboard/js/material-dashboard.min.js?v=3.0.4') }}"></script>
  </body>
