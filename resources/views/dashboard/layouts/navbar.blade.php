  ...
  <ul class="navbar-nav">
        ...
        <li class="nav-item">
				...
				<div class="collapse " id="pagesExamples">
					<ul class="nav ">
						<li class="nav-item ">
							<a class="nav-link text-white {{ Request::is('pendidikan*') ? 'active' : '' }}" href="/pendidikan">
								<span class="sidenav-mini-icon"> DP </span>
								<span class="sidenav-normal  ms-2  ps-1"> Data Pendidikan </span>
							</a>
						</li>
						<li class="nav-item ">
							<a class="nav-link text-white {{ Request::is('keahlian*') ? 'active' : '' }}" href="/keahlian">
								<span class="sidenav-mini-icon"> DK </span>
								<span class="sidenav-normal  ms-2  ps-1"> Data Keahlian </span>
							</a>
						</li>
						<li class="nav-item ">
							<a class="nav-link text-white {{ Request::is('category*') ? 'active' : '' }}" href="/category">
								<span class="sidenav-mini-icon"> DK </span>
								<span class="sidenav-normal  ms-2  ps-1"> Data Kategori </span>
							</a>
						</li>
						<li class="nav-item ">
							<a class="nav-link text-white {{ Request::is('user*') ? 'active' : '' }} " href="/user">
