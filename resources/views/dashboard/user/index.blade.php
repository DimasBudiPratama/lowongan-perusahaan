              ...
              @endif
                <div class="ms-auto my-auto">
                    <div class="ms-auto my-auto ps-3">
                        <a href="/user/create" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; Tambah Data</a>
                    </div>
                </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success">{{ $user->level}}</span>
                      </td>
                      <td class="align-middle text-center">
                          <a href="/user/{{ $user->id }}/edit" class="badge badge-sm bg-gradient-success text-white font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                            Edit
                          </a>
